...
//		}
//		//charAt() 함수 통해서 값 참조는 가능하지만 값 변경은 안 됨.
//		
//		
//		//
...
//		System.out.println("제 이름의 길이는 "+mine.length());
//		System.out.println("짝 이름의 길이는 "+yours.length());
//		
//		//equals()
//		//"LeeYuna" == "LeeYuna" 참값
...
//		System.out.println("<mine과 mine2는 동일하다.>는 "+(mine.equals(mine)));
//		
//		
		// do-while()문
...
//			System.out.println(test);
//			test++;
//		}while(test<=5 && test!=0);		//0 1 2 3 4 5 결과가 뜬다
//		
//		
//		
//		// switch문 : 학점 계산
...
//		
		...
		a=b;
		b=temp;
		System.out.println("swap 하고 난 후"+a+" "+b);
