...
public class HelloJava01_Customer_Manager {
	...
	public static void main(String[] args) {
		...
		//왜냐면 사용자 정의 자료형은 일반적인 자료형이 아니기 때문!
		//그래서 메모리를 따로 할당해줘야 함
		...
		//new 뒤에 붙은 클래스명 ()의 의미
		//메모리를 할당하기는 하는데, 얼만큼, 어떤 형태로 할당할지 정해주는 것 !!
		...
		//객체(object)라고 부른다.
		Customer c1 = new Customer();	//특수한 형태의 자료형이기 때문에 new 키워드로 메모리 할당해줌
		c1.name = "김혜민";
		c1.age = 30;
		c1.cNum = "00001";
...
//		kb1.age=100;	//is not visible , 정보의 은닉
