...
(
    function() {
        //const sounds = $('audio')   //오디오 태그들
        const sounds = document.querySelectorAll('audio')
        // const pads = $('.pads div') //pads 안에 있는 div 태그들
        ...
        //             //파일명을 적절히 잘라서 표시
        //             const strArray =
        //             sounds[index].src.split('sound/')   // sound/ 문자 기준으로 자름
